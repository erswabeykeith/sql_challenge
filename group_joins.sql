...
SELECT warehouse.warehouse, warehouse.fulfillment_days, warehouse.id, warehouse_product.warehouse_id, warehouse_product.product_id, products.id, products.description   
FROM warehouse
